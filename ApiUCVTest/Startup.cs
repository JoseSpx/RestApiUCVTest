...
namespace ApiUCVTest
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ISqlContext, SqlContext>();
            services.AddTransient<IAuthService, AuthService>();
            services.AddTransient<IClienteTrilceService, ClienteTrilceService>();
            services.AddTransient<IClienteClementinaService, ClienteClementinaService>();
